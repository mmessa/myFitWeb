...
class WorkoutsControllerTest < ActionController::TestCase
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post :create, workout: { description: @workout.description, name: @workout.name, profile_id: @workout.profile_id }
    end
  ...
  test "should update workout" do
    patch :update, id: @workout, workout: { description: @workout.description, name: @workout.name, profile_id: @workout.profile_id }
    assert_redirected_to workout_path(assigns(:workout))
  end
